...
void DoRoute(const std::shared_ptr<::trpc::test::helloworld::GreeterServiceProxy>& prx) {
  ...
  // ::trpc::naming::polarismesh::SetSelectorExtendInfo(context, std::make_pair("namespace", "Development"));
...
int Run() {
  ...
  option.service_filter_configs["polarismesh"] = extend_select_info;
...
int main(int argc, char* argv[]) {
  ...
  // Initializes the polarismesh plugin and filters after start runtime
